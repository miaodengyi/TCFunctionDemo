...
import cn.com.cybertech.tcfunctiondemo.adapter.VoiceAdapter;
import cn.com.cybertech.tcfunctiondemo.bean.VoiceBean;
import cn.com.cybertech.tcfunctiondemo.util.AudioRecoderUtils;
import cn.com.cybertech.tcfunctiondemo.util.FileSizeUtil;
import cn.com.cybertech.tcfunctiondemo.view.ItemDivider;
...
public class VoiceListActivity extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(VoiceListActivity.this));
        recyclerView.addItemDecoration(new ItemDivider(VoiceListActivity.this, R.drawable.divider_bg));
        final List<VoiceBean> list = listFile(path);
        VoiceAdapter adapter = new VoiceAdapter(VoiceListActivity.this,list);
        ...
        adapter.setOnItemClickListener(new VoiceAdapter.OnItemClickListener()
        {
            ...
            public void onClick(View parent, int position)
            {
                ...
                {
                    audioRecoderUtils = new AudioRecoderUtils(VoiceListActivity.this);
                }
                Toast.makeText(VoiceListActivity.this,list.get(position).getPath(),Toast.LENGTH_LONG).show();
