...
public class TrafficAppAdapter extends RecyclerView.Adapter<TrafficAppAdapter.MyViewHolder>
{
    ...
    public TrafficAppAdapter(Context context, List<AppInfo> mDates)
    {
        mContext = context;
        this.mDates = mDates;
    ...
    {
        MyViewHolder myViewHolder = new MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_traffic_app, parent, false));
        return myViewHolder;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position)
    {
        if (mDates!=null&&mDates.size()>0)
        {
            ...
            holder.tvName.setText(mDates.get(position).getLabel());
            holder.tvVersion.setText("版本号："+mDates.get(position).getVersionCode());
            holder.tvTraffic.setText(""+mDates.get(position).getTrafficData());
        }
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public MyViewHolder(View itemView)
        {
            ...
            tvTraffic = (TextView) itemView.findViewById(R.id.item_tv_traffic_data);
        }
    }
}
